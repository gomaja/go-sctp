...
// The explicit build constraint above documents that this copy stays in lockstep
// with its Linux-only consumer. The rest of the file is kept byte-identical to
// the standard library's net/ipsock.go.
...
func supportsIPv4() bool {
	//nolint:staticcheck // QF1008: kept byte-identical to net/ipsock.go upstream.
